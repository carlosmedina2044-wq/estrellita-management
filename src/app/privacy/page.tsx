  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col gap-4 px-5 pb-12 pt-[max(1.5rem,env(safe-area-inset-top))] text-[15px] leading-6">
      ...
      <p>
        ...
        consumables you need to reorder, and tells you when to order them.
      </p>
      ...
      <p>
        ...
        key held in the iOS Keychain. Cuidala has no user accounts and no servers that receive this data.
      </p>
      ...
      <ul className="list-disc space-y-1 pl-5">
        <li><strong>Location (optional).</strong> Used once during setup to pick seasonal tasks. Only rounded coordinates are stored.</li>
        <li><strong>Notifications (optional).</strong> Local reminders scheduled on your device for restock dates and a weekly digest.</li>
      ...
      <p>
        Use <em>Settings → Erase all data on this iPhone</em>, or delete the app. Both remove everything, including
