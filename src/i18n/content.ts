...
const DUTY_TITLE_KEYS: Record<string, MessageKey> = {
  ...
  "Review appliance warranties and manuals": "content.chore.review-appliance-warranties-and-manuals",
  "Photograph every room for the insurance file": "content.chore.photograph-every-room-for-the-insurance-file",
  "Check the water heater temperature and test the relief valve": "content.chore.check-the-water-heater-temperature-and-test-the-relief-valve",
  "Vacuum heating vents and bath exhaust fan covers": "content.chore.vacuum-heating-vents-and-bath-exhaust-fan-covers",
  "Wipe down door handles, switches and remotes": "content.chore.wipe-down-door-handles-switches-and-remotes",
  "Clean the washer drum, gasket and detergent drawer": "content.chore.clean-the-washer-drum-gasket-and-detergent-drawer",
  "Vacuum behind and under the dryer": "content.chore.vacuum-behind-and-under-the-dryer",
  "Wash windows inside and out": "content.chore.wash-windows-inside-and-out",
  "Clean the range hood filter": "content.chore.clean-the-range-hood-filter",
  "Run each irrigation zone and fix heads and leaks": "content.chore.run-each-irrigation-zone-and-fix-heads-and-leaks",
  "Walk the exterior for cracks, peeling paint and pooled water": "content.chore.walk-the-exterior-for-cracks-peeling-paint-and-pooled-water",
  "Clean ceiling fan blades and bath exhaust fans": "content.chore.clean-ceiling-fan-blades-and-bath-exhaust-fans",
  "Check under sinks and around toilets for leaks": "content.chore.check-under-sinks-and-around-toilets-for-leaks",
  "Test toilet fill valves and flappers for running water": "content.chore.test-toilet-fill-valves-and-flappers-for-running-water",
  "Wash out trash and recycling bins": "content.chore.wash-out-trash-and-recycling-bins",
  "Flush slow drains with hot water and baking soda": "content.chore.flush-slow-drains-with-hot-water-and-baking-soda",
  "Clean the dishwasher filter and run a cleaning cycle": "content.chore.clean-the-dishwasher-filter-and-run-a-cleaning-cycle",
  "Clean the garbage disposal with ice and citrus": "content.chore.clean-the-garbage-disposal-with-ice-and-citrus",
  "Check exterior lights and replace bulbs": "content.chore.check-exterior-lights-and-replace-bulbs",
  "Lubricate door locks and hinges": "content.chore.lubricate-door-locks-and-hinges",
  "Test the garage door auto-reverse and lubricate the rails": "content.chore.test-the-garage-door-auto-reverse-and-lubricate-the-rails",
  "Check the fire extinguisher gauge and expiry date": "content.chore.check-the-fire-extinguisher-gauge-and-expiry-date",
  "Check detector manufacture dates; replace any over ten years old": "content.chore.check-detector-manufacture-dates-replace-any-over-ten-years-old",
  "Check for drafts at windows and doors": "content.chore.check-for-drafts-at-windows-and-doors",
  "Check extension cords, outlet loads and light strings": "content.chore.check-extension-cords-outlet-loads-and-light-strings",
  "Check space heaters for damaged cords and tip-over shutoff": "content.chore.check-space-heaters-for-damaged-cords-and-tip-over-shutoff",
