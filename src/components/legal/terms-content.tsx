export function TermsContent() {
  return (
    <div className="grid gap-3 text-[15px] leading-6">
      ...
      <p>
        These additional terms apply to Cuidala on the App Store. Apple’s Standard EULA also applies, as set in
        App Store Connect.
      </p>
      <p>Cuidala is for a single household on a single iPhone in the United States.</p>
      <p>
        Cuidala helps you organise home maintenance. Reminders, seasonal checklists, cost forecasts, and
        replacement estimates are informational only. They are generated from what you enter and from national
        typical figures, 2026. They are not professional advice. Always follow manufacturer instructions and local
        codes, and consult a qualified professional for electrical, gas, structural, roof, pest, or safety-related
        work.
      </p>
      <p>
        Retailer links open third-party websites. Purchases are made with the retailer under its terms; Cuidala is
      ...
      <p>
        ...
        liable for consequential, incidental, special, or lost-profit damages, and liability is limited to the
        amount you paid for the app.
      </p>
      <p>
