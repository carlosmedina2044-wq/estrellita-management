      ...
      {windows.length === 0 ? (
        <>
          ...
          <img
            ...
            alt=""
            draggable={false}
            className="pointer-events-none absolute inset-0 h-full w-full object-contain mix-blend-screen blur-[6px]"
            style={{
          ...
          return (
            <span key={w.id} className="contents">
              ...
              <img
                ...
                style={{ clipPath: clip, opacity: on ? 1 : 0 }}
              />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={layers.lit}
                ...
                style={{ clipPath: clip, opacity: on ? 0.6 : 0 }}
              />
            </span>
          );
        })
