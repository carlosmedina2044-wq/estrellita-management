  ...
  return (
    <div className="rounded-2xl bg-card p-4">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        iCloud device backup restores the encrypted home but not the Keychain key. If you get a new iPhone,
        you’ll need this file plus the passphrase you set here. Cuidala cannot recover a forgotten passphrase.
      </p>
      <Input
        type="password"
        value={passphrase}
